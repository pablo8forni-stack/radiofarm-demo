...
const VACIO_VIAL = { lote: "", fechaCalibracion: "", actividadCalibrada: "", volumenInicial: "", fechaVencimiento: "", obs: "" };
...
export function TabStockViales({ catalogo, usuario, esAdmin, onToast }) {
  ...
  const vialesFiltrados = useMemo(
    () => viales.filter((v) => !filtroSede || v.sedeId === filtroSede)
          ...
          <table className="w-full text-sm min-w-[860px]">
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50/60">
                {["Lote", "Sede", "Calibración", "Act. calibrada", "Vol. inicial", "Vol. restante", "Act. restante (calc.)", "Vencimiento", ""].map((h, i) => (
